...
const ServiceCard = ({
  ...
  return (
    <motion.div
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t from-background/20 to-transparent"></div>
    </motion.div>
  );
};
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      <Carousel
        ...
        <CarouselNext
          className="bg-foreground/10 border-0 hover:bg-foreground/20 text-foreground" />
      </Carousel>
    </div>
  );
};